...
I want to analysis on all three consoles together. The best way to do that is to join my data frames together. There are multiple joins avaiable to me in R. Considering that they have the exact same variables, it  makes the most sense to create  a new dataframe using bind_rows. I originally created in by combining  WiiU_df with the PS4_df and then the combined dataframe with the Xbox1_df.    
...
It is a lot easier to see how skewed the data is as well as the concentration of scores.  The mean and median are much better observed here as well.
 ...
 Now another thing that could be done differently. Instead of creating mutiple 6 plots with 6 ggplot functions, I could have made them with two through the use of facetting. Facetting simply means you can create mutliple plots   
